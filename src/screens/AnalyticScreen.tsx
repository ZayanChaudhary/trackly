...
export default function AnalyticScreen() {
    ...
    const fetchAnalytics = async () => {
        try {
            ...
            const weeklyCompletions = dailyData.reduce((sum, count) => sum + count, 0);
        ...
        <ScrollView style={styles.container}>
            ...
            <View style={styles.statsContainer}>
                ...
                <View style={styles.statCard}>
                    ...
                    <Text style={styles.statNumber}>{data.completionRate.toFixed(0)}%</Text>
            ...
            <View style={styles.summarySection}>
                ...
                <View style={styles.summaryCard}>
                    ...
                    <View style={styles.summaryRow}>
                        ...
                        <Text style={styles.summaryValue}>{data.completionRate.toFixed(1)}%</Text>
                    </View>
                </View>
            </View>
            ...
            <View style={styles.aiSection}>
                ...
                <View style={styles.aiPlaceholder}>
                    ...
                    <Text style={styles.aiPlaceholderSubtext}>
